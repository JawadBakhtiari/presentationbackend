...
interface UpdatePresentationModalProps {
...
const UpdatePresentationModal: React.FC<UpdatePresentationModalProps> = ({
  presentation,
  onClose,
  onUpdate,
  onDelete,
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded shadow-md w-full max-w-md relative">
        ...
        <h2 className="text-2xl font-bold mb-4">Update Presentation</h2>
        <input
          type="text"
          placeholder="Name"
